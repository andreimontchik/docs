...
- [Economics of running Validator](https://docs.solanalabs.com/operations/validator-or-rpc-node#economics-of-running-a-consensus-validator)
  ...
  - According to [Validator Calculator](https://cogentcrypto.io/ValidatorProfitCalculator) just running a voting Validator with the $110 SOL price will cost **$3,600** a month. The break even point is **80,000 SOL** stake with 5% commission.
...
## [Install and Configure](Install-and-Configure-Validator.md)
