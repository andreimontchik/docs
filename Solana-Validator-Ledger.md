...
1. Full snapshots contain __all accounts at a specific slot__, example: `snapshot-100-D17vR2iksG5RoLMfTX7i5NwSsr4VpbybuX1eqzesQfu2.tar.zst`
1. Incremental snapshots contain __accounts that were changed between specific slots__. Example: `incremental-snapshot-100-200-AvFf9oS8A8U78HdjT9YG2sTTThLHJZmhaMn2g8vkWYnr.tar.zst`
...
1. [Install and configure Solana](install-solana) to install the `solana-ledger-tool`.
