...
# [Setup Local Dev Env-t](https://solana.com/developers/guides/getstarted/setup-local-development#dependencies-for-linux)
  1. Install the Linux Dependencies: 
     ...
     ```
  1. Configure and run [Test Validator](test-validator)
...
# [Solana On-Chain Programs](Solana-On‐Chain-Programs)
  * [Anchor](Anchor)
...
# Solana Clients
  * [JavaScript Web3.js Client](Solana-web3.js-Client)
